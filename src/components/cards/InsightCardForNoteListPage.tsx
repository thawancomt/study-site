...
const colorVariants: Record<InsightCardProps["colorVariant"], string> = {
    orange: "bg-gradient-to-br from-chart-1/40 to-chart-5/60 hover:shadow-chart-1/30 text-accent",
    blue: "bg-gradient-to-br from-chart-2/40 to-chart-3/60 hover:shadow-chart-2/30 text-accent",
    purple: "bg-gradient-to-br from-chart-3/40 to-chart-2/60 hover:shadow-chart-3/30 text-accent",
    green: "bg-gradient-to-br from-chart-4/40 to-chart-5/60 hover:shadow-chart-4/30 text-accent",
    yellow: "bg-gradient-to-br from-chart-5/40 to-chart-1/60 hover:shadow-chart-5/30 text-accent",
};
